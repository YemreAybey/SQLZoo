...
WHERE num IN (SELECT num FROM stops JOIN route ON id = stop  
...
SELECT DISTINCT Route1.num as NumFrom, Route1.company CoFrom, name, Route2.num as NumTo, Route2.company CoTo
FROM stops
