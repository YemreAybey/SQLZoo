/* 1-Change the query shown so that it displays 
...
/* 3-Show the year and subject that won 
   'Albert Einstein' his prize. */
...
/* 5-Show all details (yr, subject, winner) of the 
...
/* 8-Show the year, subject, and name of 
   Physics winners for 1980 together with the 
