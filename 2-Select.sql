...
/* Show the countries which have a name that 
...
/* Show the countries that are big by area or 
   big by population but not both */
SELECT name, population, area from world 
  WHERE (population > 250000000 and area < 3000000) 
  OR (population < 250000000 and area > 3000000);

/* For South America show population in millions and 
